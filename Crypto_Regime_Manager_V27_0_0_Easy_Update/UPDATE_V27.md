...
## Installation
Extract the ZIP directly inside the existing project folder and run `INSTALL_V27_EASY.bat`. Commit and push the installed files, then run the **V27 Autonomous Crypto Regime Refresh** workflow once.
