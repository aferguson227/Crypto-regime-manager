...
Write-Host "Installing Crypto Regime Manager V24.0.0..." -ForegroundColor Cyan
$stamp=Get-Date -Format 'yyyyMMdd_HHmmss'
$backup=Join-Path $ProjectRoot "backups\v24_$stamp"
...
Write-Host "V24.0.0 installed successfully." -ForegroundColor Green
