...
def main():
 rb=load('regime_backtest_intelligence.json');oq=load('optimisation_queue.json');rp=load('research_pipeline.json');hist=load('historical_data_status.json');kw=load('kucoin_walk_forward.json');items=oq.get('items') or []
 states={}
