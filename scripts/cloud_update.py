...
if __name__ == '__main__':
    ...
    try:
        ...
        from scripts.github_actions_intelligence_engine import main as github_actions_intelligence
        github_actions_intelligence()
        from scripts.decision_quality_engine import main as decision_quality
        decision_quality()
        from scripts.engineering_intelligence_engine import main as engineering_intelligence
