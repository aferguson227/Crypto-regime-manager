...
def run(offline: bool = False) -> dict[str, Any]:
    ...
    result = {
        "version": "25.0.0", "generated_at": generated, "mode": "research_only", "source": source,
    ...
    registry_path.write_text(json.dumps({"version":"25.0.0","generated_at":generated,"candidates":candidates}, indent=2), encoding="utf-8")
    return result
