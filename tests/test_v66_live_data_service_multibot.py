...
def test_dashboard_data_destructuring_matches_v2_outputs():
 s=text('docs/unified_dashboard.js')
 assert 'portfolioCapitalV2,integrityStatus,liveRevalidation,fastLiveTruth,canonicalKucoin,livePrices,liveService,paperPortfolio,managedPortfolio,managedRegistry,ver' in s
