...
def test_v39_identity():
 ...
 assert json.loads((ROOT/'app/release.json').read_text(encoding='utf-8'))['release_name']=='Autonomous Development Platform'
def test_v39_components():
 for p in ['scripts/issue_lifecycle_engine.py','scripts/repository_hygiene_engine.py','scripts/engineering_scheduler.py','config/generated_outputs_policy.json','RUN_ENGINEERING_AUDIT.cmd','PREPARE_RELEASE.cmd','.github/workflows/engineering-audit.yml']:
